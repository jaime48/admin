            ...
            <div class="left_col scroll-view">
                ...
                <div class="profile clearfix">
                    <div class="profile_pic">
                        <img src="{{asset('img/template/avatar.jpg')}}" alt="..." class="img-circle profile_img">
                    </div>
                    ...
                    <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
                        <div class="menu_section">
                            ...
                            <ul class="nav side-menu">
                                <li><a href="{{route('home')}}"><i class="fa fa-bar-chart"></i> 主页 </a>
                                <li><a href="{{route('contact')}}"><i class="fa fa-comments"></i> 联系人 </a>

                                </li>
                                <li><a href="{{route('permission')}}"><i class="fa fa-group"></i> 管理员授权 </a>

                                </li>
                                <li><a href="{{route('user')}}"><i class="fa fa-group"></i> 用户管理 </a>

                                </li>
                                <li><a href="{{route('order')}}"><i class="fa fa-archive"></i> 订单管理 </a>

                                </li>
                                <li><a href="{{route('payment')}}"><i class="fa fa-credit-card"></i> 还款管理 </a>
                                ...
                                {{--<li><a><i class="fa fa-edit"></i> 表单 <span class="fa fa-chevron-down"></span></a>--}}
                                    ...
                                    {{--</ul>--}}
                                {{--</li>--}}
                                {{--<li><a><i class="fa fa-desktop"></i> UI <span class="fa fa-chevron-down"></span></a>--}}
                                    {{--<ul class="nav child_menu">--}}
                                ...
                                {{--<li><a><i class="fa fa-bar-chart-o"></i> 数据展示 <span class="fa fa-chevron-down"></span></a>--}}
                                    ...
                                    {{--</ul>--}}
                                {{--</li>--}}
                                {{--<li><a><i class="fa fa-clone"></i>布局 <span class="fa fa-chevron-down"></span></a>--}}
                                    {{--<ul class="nav child_menu">--}}
                        ...
                        {{--<div class="menu_section">--}}
                            {{--<h3>Live On</h3>--}}
                            {{--<ul class="nav side-menu">--}}
                                {{--<li><a><i class="fa fa-bug"></i> 附加页面 <span class="fa fa-chevron-down"></span></a>--}}
                                    {{--<ul class="nav child_menu">--}}
                                    ...
                                    {{--</ul>--}}
                                {{--</li>--}}
                                {{--<li><a><i class="fa fa-windows"></i> 额外 <span class="fa fa-chevron-down"></span></a>--}}
                                    {{--<ul class="nav child_menu">--}}
                                    ...
                                    {{--</ul>--}}
                                {{--</li>--}}
                                {{--<li><a><i class="fa fa-sitemap"></i> 多重目录 <span class="fa fa-chevron-down"></span></a>--}}
                                    {{--<ul class="nav child_menu">--}}
